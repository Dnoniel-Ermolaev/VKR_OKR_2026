...
{{
  ...
  "explanation": "Краткое объяснение на русском (3-5 предложений, без диагноза, опирайся на retrieved context)"
}}
"""
...
Ты формируешь клинический отчет/эпикриз по кейсу ОКС в учебном прототипе.
Используй только переданные данные кейса и retrieved context.
...
Верни строго JSON формата:
{{
  "report": "Структурированный клинический отчет на русском языке с секциями: Жалобы, Диагностические данные, Оценка риска, Динамика, Предварительные рекомендации"
}}
"""
